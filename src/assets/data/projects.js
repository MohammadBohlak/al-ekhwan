...
export const services = [
  {
    ...
    description: "تصميم وبناء المباني السكنية بأحدث المعايير العالمية وأفضل المواد المحلية والمستوردة"
  },
  {
    icon: "🏭",
    title: "المباني التجارية",
    description: "إنشاء المجمعات التجارية والمكاتب والمصانع بتصاميم عصرية ومواصفات تقنية متقدمة"
  },
  {
    icon: "🛣️",
    title: "البنية التحتية",
    description: "تنفيذ مشاريع الطرق والجسور وشبكات المياه والصرف الصحي بجودة عالية"
  },
  {
    icon: "🏗️",
    title: "التشطيبات",
    description: "أعمال التشطيبات الداخلية والخارجية بأحدث التقنيات وأجمل التصاميم"
  },
  {
    icon: "🎯",
  ...
  },
  {
    ...
    description: "خدمات التصميم المعماري والإنشائي بأحدث البرامج والتقنيات الهندسية"
  }
];
...
export const featuredProjects = [
  {
    ...
    description: "مشروع سكني متكامل يضم 150 وحدة سكنية بمساحات متنوعة ومرافق حديثة",
...
export const clients = [
  ...
  { logo: null, url: "https://client7.com" },
  { logo: null, url: "https://client8.com" },
  { logo: null, url: "https://client9.com" },
  { logo: null, url: "https://client10.com" }
...
// أعضاء الفريق
export const teamMembers = [
  { image: null, name: "المهندس أحمد العلي", position: "مدير المشاريع" },
  { image: null, name: "المهندسة سارة يوسف", position: "رئيسة قسم التصميم" },
  { image: null, name: "المهندس خالد حسن", position: "المدير التنفيذي" }
...
export const contactInfo = [
  {
    icon: "📞",
    title: "الهاتف",
    details: "+963 930 817 280<br>+963 962 447 416"
  },
  {
    icon: "✉️",
  ...
  },
  {
    icon: "📍",
    title: "العنوان",
    details: "حمص , الدبلان<br>شارع العراب "
  },
  {
    icon: "🕒",
    title: "ساعات العمل",
    details: "السبت - الخميس<br>8:00 ص - 6:00 م"
  }
];