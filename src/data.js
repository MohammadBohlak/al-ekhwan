export const data = {
  hero: [
    {
      id: 5,
      title: "باتيك لصناعة الواح البيتونية",
      image: "/media/hero/batec.jpg",
      order: 1,
    },
    {
      id: 1,
      title: "شركة المتين للصناعات البلاستيكية",
      image: "/media/hero/almatin.JPG",
      order: 2,
    },
    {
      id: 2,
      title: "مطبعة دار جلّق",
      image: "/media/hero/dar_jellaq_2.JPG",
      order: 3,
    },
    {
      id: 3,
      title: "سلمى لصناعة الزيوت",
      image: "/media/hero/salma.jpg",
      order: 4,
    },
    {
      id: 4,
      title: "ستارش لصناعة النشاء",
      image: "/media/hero/starch.JPG",
      order: 5,
    },
  ],
  projects: [
  ...
  clients: [
    {
      id: 1,
      logo: "/media/clients/logo_almatin-removebg-preview.png",
      name: "المتين",
      order: 1,
    },
    {
      id: 3,
      logo: "/media/clients/batic-logo-removebg-preview.png",
      name: "باتيك",
      order: 2,
    },
    {
      id: 4,
      logo: "/media/clients/Salma-Oil-Logo.png",
      name: "سلمى",
      order: 3,
    },
    {
      id: 5,
      logo: "/media/clients/rasco-logo-removebg-preview.png",
      name: "راسكو",
      order: 4,
    },
    {
      id: 6,
      logo: "/media/clients/jood-logo-removebg-preview.png",
      name: "مصاعد جود",
      order: 5,
    },
    {
      id: 7,
      logo: "/media/clients/dar_jellaq-logo.png",
      name: "دار جلّق",
      order: 6,
    },
    {
      id: 8,
      logo: "/media/clients/photo_2025-08-16_13-31-11-removebg-preview.png",
      name: "مدافئ الأصل الوصال",
      order: 7,
    },
  ],
  team: [],
